...
import torch
from networks.net_all import net_all_3d
from test_utils import test_all_case

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='../data/data_8_h5', help='Name of Experiment')
...
def Inference(FLAGS):
    ...
    net = net_all_3d(net_type=FLAGS.model, in_chns=1, class_num=num_classes).cuda()
